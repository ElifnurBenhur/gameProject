...
public class Main {
    public static void main(String[] args) {
        ...
        gamerManager.create(new Gamer("111112", "Yıldız", "Demir", new Date(1999,1,1), 1, "1234", "user1", null));
        //Kullanıcı E-devlet sistemi ile uyumlu olan kullanıcı bilgilerini girer ve
        //kayıt ol tuşuna basar;
        gamerManager.create(new Gamer("111111111", "Ahmet", "Yılmaz", new Date(1999,1,1), 1, "1234", "user1", null));
        //başka bir kullanıcı kayıt olur
        gamerManager.create(new Gamer("211111111", "Ayşe", "Özdemir", new Date(1998,1,1), 2, "1235", "user2", null));
        //kullanıcı bilgilerini güncelle sayfasından değiştirerek güncelle butonuna basar;
        gamerManager.update(new Gamer("211111111", "Ayşe", "Özdemir", new Date(1998,1,1), 2, "1236", "user3", null));
        ...
        ArrayList<Game> carts=new ArrayList<Game>();
        carts.add(gameManager.read(3));
        carts.add(gameManager.read(1));
        // ve satın al butonuna basar;
        orderManager.create(new Order(1,new Date(2023,3,16),carts,gamerManager.read(1),false));
